...
- [3. Important Premise](#3-important-premise)
- [4. Quick Start (9 steps)](#4-quick-start-9-steps)
- [5. Connecting to the ENZO-TS Network](#5-connecting-to-the-enzo-ts-network)
    - [5.1. Sign-up to Get the Login Credentials](#51-sign-up-to-get-the-login-credentials)
    - [5.2. Store your Permanent Login Key](#52-store-your-permanent-login-key)
    - [5.3. Previewing the Trading Signals](#53-previewing-the-trading-signals)
- [6. Connecting to the Exchange](#6-connecting-to-the-exchange)
- [7. Preparing the Funds for Trading](#7-preparing-the-funds-for-trading)
- [8. The ENZO-TSL Launcher Application](#8-the-enzo-tsl-launcher-application)
- [9. The ENZO-TSV Viewer Application](#9-the-enzo-tsv-viewer-application)
- [10. The Log Window](#10-the-log-window)
- [11. API Keys and Security](#11-api-keys-and-security)
- [12. Extra Features](#12-extra-features)
    - [12.1. Market Watch](#121-market-watch)
    - [12.2. High-Frequency Display](#122-high-frequency-display)
    - [12.3. Volume Heat-Map](#123-volume-heat-map)
...
- A Binance Exchange account created with our [referral link](https://www.binance.com/en/register?ref=HO802SIU) (see the site for alternatives)
...
>
> Depending on the volatility of the market, our model risks from -1.5% to -3.0% of the capital afforded for each trade, with the potential to reach -4% per-trade in some rare cases.
> Notice that risk level and size of the stop-loss don't always match. Some positions may naturally set a -3.5% stop-loss but still maintain a -3% risk level buy purchasing a smaller quantity of BTC. For more details, please visit the [ENZO-TSC product page][ENZOTSCProduct].
>
...
# 8. The ENZO-TSV Viewer Application
